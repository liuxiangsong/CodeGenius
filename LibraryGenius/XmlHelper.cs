...
namespace LibraryGenius
{
    ...
    public class XmlHelper
    {
        ...
        public XmlHelper(string xmlFileSavePath, string rootName)
        {
            try
            {
        ...
        /// <param name="attrValue">属性值</param>
        /// <returns></returns>
        public XmlHelper AddAttribute(XmlElement element, string attrName, string attrValue)
        {
            element.SetAttribute(attrName, attrValue);
            return this;
        }
        ...
        /// <param name="innerText">文本内容</param>
        /// <returns></returns>
        public XmlHelper AddInnerText(XmlElement element, string innerText)
        {
            element.InnerText = innerText;
            return this;
        }
